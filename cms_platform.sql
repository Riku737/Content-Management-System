...
(2, 1, 'Our Story', 2, 1, '<div id="hero-image">\n  <img src="images/page_assets/history.png" width="900" height="200" alt="" />\n</div>\n\n<div id="content">\n  <h1>Our Story</h1>\n  <p>Techno1ogy was founded by visionary engineers Maya Lin and Carlos Rivera, who believed technology should be accessible and transformative for everyone. Starting from a small garage in Austin, Texas, they built a company that now powers digital experiences for millions worldwide.</p>\n  <p>Key milestones include the launch of our AI-driven platform in 2008, our expansion into Europe and Asia in 2012, and our recent acquisition of GreenSpark Innovations, a leader in sustainable tech. Our growth is fueled by a passion for solving real-world problems and a culture of collaboration.</p>\n  <p>Today, Techno1ogy is led by a diverse team, continuing the founders\' legacy of innovation and social responsibility.</p>\n</div>\n'),
(3, 1, 'Leadership', 3, 1, '<div id="hero-image">\n  <img src="images/page_assets/leadership.png" width="900" height="200" alt="" />\n</div>\n\n<div id="content">\n  <h1>Leadership</h1>\n  <h2>Board of Directors</h2>\n  <ul>\n    <li>Maya Lin, Chairwoman</li>\n    <li>Carlos Rivera</li>\n    <li>Priya Desai</li>\n    <li>Elena Petrova</li>\n    <li>Samuel Okafor</li>\n    <li>Linda Zhang</li>\n    <li>Omar Al-Farsi</li>\n    <li>Julia Novak</li>\n    <li>Victor Moreau</li>\n    <li>Fatima El-Sayed</li>\n  </ul>\n  <h2>Executive Team</h2>\n  <ul>\n    <li>Priya Desai, Chief Executive Officer</li>\n    <li>Samuel Okafor, Chief Technology Officer</li>\n    <li>Linda Zhang, Chief Financial Officer</li>\n    <li>Elena Petrova, Chief Operating Officer</li>\n    <li>Omar Al-Farsi, Chief Innovation Officer</li>\n    <li>Julia Novak, VP of Human Resources</li>\n    <li>Victor Moreau, VP of Global Strategy</li>\n    <li>Fatima El-Sayed, General Counsel</li>\n  </ul>\n</div>\n'),
